namespace LiteApi.Attributes
{
    public static class AttributeConventions
    {
        public static string ErrorResolutionSuggestion =>
            ...
            + "source of parameter (from body or from URL) is resolved by type of parameter. If type of parameter can be found in LiteApi.Contracts.ActionParameter.SupportedTypesFromUrl (most of the basic types) "
